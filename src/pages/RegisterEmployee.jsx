...
export default function RegisterEmployee({ navigate, params }) {
  ...
  if (success) return (
    <div style={{ textAlign: 'center', padding: '80px 20px' }}>
      ...
      <div style={{ fontSize: 18, fontWeight: 600, marginBottom: 8 }}>Profile created!</div>
      <p style={{ fontSize: 13, color: 'var(--text2)', marginBottom: 8 }}>Welcome {form.name}! Your portable profile is live.</p>
      <p style={{ fontSize: 12, color: 'var(--text3)', marginBottom: 24 }}>Share your review link with clients to start building your reputation.</p>
  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 16px', borderBottom: '1px solid var(--border)', background: '#fff', position: 'sticky', top: 0, zIndex: 100 }}>
        ...
        <span style={{ fontSize: 14, fontWeight: 500 }}>Create Employee Profile</span>
        <div style={{ width: 32 }} />
      </div>
      <div style={{ padding: 16 }}>
        ...
        <div style={{ marginBottom: 14 }}>
          <label style={{ fontSize: 12, fontWeight: 500, color: 'var(--text2)', display: 'block', marginBottom: 6 }}>Years of experience</label>
        ...
        <div style={{ marginBottom: 14 }}>
          <label style={{ fontSize: 12, fontWeight: 500, color: 'var(--text2)', display: 'block', marginBottom: 6 }}>
            Emirates ID / Work Permit <span style={{ fontWeight: 400, color: 'var(--text3)' }}>(for verification)</span>
          </label>
          <label style={{ display: 'block', border: '1.5px dashed var(--border)', borderRadius: 'var(--radius-lg)', padding: 16, textAlign: 'center', cursor: 'pointer' }}>
            <i className="ti ti-id" style={{ fontSize: 24, color: 'var(--text3)' }} />
            <p style={{ fontSize: 12, color: 'var(--text2)', marginTop: 6 }}>{emiratesId ? `✓ ${emiratesId.name}` : 'Upload Emirates ID or Work Permit'}</p>
            <p style={{ fontSize: 11, color: 'var(--text3)' }}>Verified badge will be added after manual review</p>
