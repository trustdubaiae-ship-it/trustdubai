...
export default function CompanyCard({ company, onClick }) {
  return (
    <div onClick={onClick} style={{
      ...
      padding: 12, marginBottom: 10, cursor: 'pointer', background: 'var(--bg-card)',
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 5, marginBottom: 4 }}>
        ...
        <span style={{ fontSize: 13, fontWeight: 500, color: 'var(--text-primary)' }}>{company.avg_rating || '0.0'}</span>
        <span style={{ fontSize: 12, color: 'var(--text-muted)' }}>({company.total_reviews || 0} reviews)</span>
      </div>
